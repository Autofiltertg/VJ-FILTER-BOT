...
PICS = (environ.get('PICS', 'https://magandi.onrender.com/wCp9.JPG')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://magandi.onrender.com/W9Hm.JPG")
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/How_To_Open_Linkl")
SPELL_IMG = environ.get("SPELL_IMG", "https://magandi.onrender.com/UtMH.JPG")

# Admins, Channels & Users
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002492075704'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7052947046').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001698487847').split()]
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002357077192')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002261656013')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', LOG_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002265727359')).split()]
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002360045140').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '+dZkkjEbgGv8wM2Nl') # Support Chat Link Without https:// or @
...
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/+dZkkjEbgGv8wM2Nl')
...
MSG_ALRT = environ.get('MSG_ALRT', 'Jai Mahakal 🙏❤️')
